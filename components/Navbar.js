      ...
      <AppBar position="static" color="transparent" sx={{ boxShadow: "none" }}>
        ...
        >
          ...
          {isTablet && (
            <Box sx={{ flexGrow: 1, display: "flex", alignItems: "center" }}>
              ...
              >
                {" "}
                <Image src={logo} alt="logo_Image" width={150} height={35} />
              </Box>
              <Link href="/">
                <Button
                  variant="contained"
        ...
        >
          ...
          >
            ...
            <Link href="/products">
              <Button variant="inherit">Products</Button>
            </Link>
            <Link href="/products">
              <Button variant="inherit">Accessories</Button>
            </Link>
            ...
            <Link href="/contactUs">
              <Button variant="inherit">Contact Us</Button>
            </Link>
          </Paper>
        </Box>
      </AppBar>
